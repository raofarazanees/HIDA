...
export class CommonEffects {
  @Effect() getOntologyMappings$ = this.actions$.pipe(
    ...
    switchMap((action: any) =>
      this.manufacturerService.getAllMasterValues(action.payload).pipe(
  ...
  @Effect() getChangeLogMapID$ = this.actions$.pipe(
    ...
    switchMap((action: any) =>
      this.manufacturerService.getMasteredMapIDChangeLog(action.payload).pipe(
  ...
  @Effect() onMasteredRecordUpdate$ = this.actions$.pipe(
    ...
    switchMap((action: any) =>
      this.manufacturerService.updateMasteredRecord(action.payload).pipe(
        map((response: any) => {
