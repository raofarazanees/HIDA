...
import { I2PItemPairsForResolutionDialogComponent } from './i2p-item-pairs-for-resolution-dialog.component';
...
describe('I2PItemPairsForResolutionDialogComponent', () => {
  let component: I2PItemPairsForResolutionDialogComponent;
  let fixture: ComponentFixture<I2PItemPairsForResolutionDialogComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      schemas: [NO_ERRORS_SCHEMA, CUSTOM_ELEMENTS_SCHEMA],
      imports: [CommonModule, MatButtonModule, MatIconModule, MatListModule, FlexLayoutModule],
      declarations: [I2PItemPairsForResolutionDialogComponent, LoaderComponent],
      providers: [
        {
          provide: Store,
          useClass: StoreMock
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(I2PItemPairsForResolutionDialogComponent);
  ...
  it('Should have valid file name ', () => {
    // @ts-ignore
    const isValid = component.validateNaming('HIDA_ItemPairs_ForResolution_UP_oct_2022_dev.csv');
    expect(isValid).toBeTruthy();
  });
  ...
  it('Should return true if file details validated', () => {
    // @ts-ignore
    const isValid = component.validateFileRules({ name: 'HIDA_ItemPairs_ForResolution_UP_oct_2022_dev.csv', size: 2048 });
    fixture.detectChanges();
    expect(isValid).toBeTruthy();
  });
