...
import { AttributeMasterDialogComponent } from './attribute-master-dialog.component';
...
describe('AttributeMasterDialogComponent', () => {
  let component: AttributeMasterDialogComponent;
  let fixture: ComponentFixture<AttributeMasterDialogComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      schemas: [NO_ERRORS_SCHEMA, CUSTOM_ELEMENTS_SCHEMA],
      imports: [CommonModule, MatButtonModule, MatIconModule, MatListModule, FlexLayoutModule],
      declarations: [AttributeMasterDialogComponent, LoaderComponent],
      providers: [
        {
          provide: Store,
          useClass: StoreMock
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AttributeMasterDialogComponent);
  ...
  it('Should have valid file name ', () => {
    // @ts-ignore
    const isValid = component.validateNaming('HIDA_Attribute_Master_UP_dev.csv');
    expect(isValid).toBeTruthy();
  });

  it('Should return false if file name not valid', () => {
    // @ts-ignore
    const isValid = component.validateNaming('HIDA_Attribute_Products_.csv');
    expect(isValid).toBeFalsy();
  });
  ...
  it('Should return true if file details validated', () => {
    // @ts-ignore
    const isValid = component.validateFileRules({ name: 'HIDA_Attribute_Master_UP_dev.csv', size: 2048 });
    fixture.detectChanges();
    expect(isValid).toBeTruthy();
  });
