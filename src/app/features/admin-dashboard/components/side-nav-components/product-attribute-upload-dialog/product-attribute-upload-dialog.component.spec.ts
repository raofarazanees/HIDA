...
import { ProductAttributeUploadDialogComponent } from './product-attribute-upload-dialog.component';
...
describe('ProductAttributeUploadDialogComponent', () => {
  let component: ProductAttributeUploadDialogComponent;
  let fixture: ComponentFixture<ProductAttributeUploadDialogComponent>;

  beforeEach(async () => {
   await TestBed.configureTestingModule({
      schemas:[NO_ERRORS_SCHEMA,CUSTOM_ELEMENTS_SCHEMA ],
      imports:[ CommonModule, MatButtonModule, MatIconModule, MatListModule, FlexLayoutModule ],
      declarations: [ ProductAttributeUploadDialogComponent,LoaderComponent ],
      providers: [ {
        provide: Store,
        useClass: StoreMock
      },
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ProductAttributeUploadDialogComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();
  });
  
  it('should product attribute component create', () => {
  ...
  it('Should have valid file name ', () => {
    // @ts-ignore
  const isValid = component.validateNaming('HIDA_Product_Attribute_Tagging_UP_dev.csv');
  expect(isValid).toBeTruthy();
  ...
  it('Should return false if file name not valid', () => {
    // @ts-ignore
  const isValid = component.validateNaming('HIDA_Products_Attribute.csv');
  expect(isValid).toBeFalsy();
  ...
  it('Should return true if file details validated', () => {
   // @ts-ignore
    const isValid = component.validateFileRules({name:'HIDA_Product_Attribute_Tagging_UP_dev.csv',size:2048});
    fixture.detectChanges();
    expect(isValid).toBeTruthy();
